...
csv_2025_df = pd.read_csv("2025.csv")
csv_2026_df = pd.read_csv("2026.csv")

# 取得第一列（index=0）所有欄位的值，轉為整數列表
actual_values = actual_df.iloc[0].astype(int).tolist()
csv_2025_values = csv_2025_df.iloc[0].astype(int).tolist()
csv_2026_values = csv_2026_df.iloc[0].astype(int).tolist()
...
# 繪製線條（line1/2/3 是 List[Line2D]，取 [0] 得到物件）
line1 = plt.plot(
    data_2025["月份"],
    data_2025["工單數量"],
    "o-",
